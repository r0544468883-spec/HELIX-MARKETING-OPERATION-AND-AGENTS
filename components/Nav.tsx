...
export default async function Nav({ locale }: { locale: string }) {
  ...
  const t =
    locale === 'en'
      ? { requests: 'Requests', vault: 'Vault', brand: 'Brand', channels: 'Channels', marketing: 'Marketing', campaigns: 'Campaigns', landing: 'Landing', templates: 'Templates', coach: 'Coach', newRequest: 'New request', login: 'Log in', logout: 'Log out' }
      : { requests: 'בקשות', vault: 'כספת', brand: 'מותג', channels: 'ערוצים', marketing: 'שיווק', campaigns: 'קמפיינים', landing: 'דפי נחיתה', templates: 'תבניות', coach: 'מאמן', newRequest: 'בקשה חדשה', login: 'התחברות', logout: 'התנתקות' };
      ...
      <div className="max-w-[1280px] mx-auto px-5 md:px-10 h-16 flex items-center justify-between gap-4">
        ...
        <NavLinks
          items={[
            ...
            { href: L('/coach'), label: t.coach, hideSm: true },
          ]}
        />
