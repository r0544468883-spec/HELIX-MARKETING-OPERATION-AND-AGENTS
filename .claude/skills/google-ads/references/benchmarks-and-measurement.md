...
Spend, leads, CPL, lead-to-SQL rate (from CRM), SQLs, cost per SQL, Search Impression Share, and top wasted search terms. If those eight are healthy and trending right, the account is healthy. Everything else is detail.
