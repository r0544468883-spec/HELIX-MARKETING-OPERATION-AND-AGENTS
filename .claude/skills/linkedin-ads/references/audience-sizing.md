...
**The problem:** Pipeline data showed many different job titles from the sales persona (dozens on a quarterly view). But LinkedIn demographics showed the variety of titles in the paid pipeline was less than half of the blended pipeline - paid ads were missing ICP members with unexpected titles.
