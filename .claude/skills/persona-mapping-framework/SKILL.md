...
title: Persona mapping framework
...
4. Designer creates visual assets
   → Follow LinkedIn's current image, headline, and intro-text specs for each ad format
...
**Critical:** Volume of ads must follow the budget math - each ad needs enough daily spend to generate 3-4 clicks, so don't create more ads than your budget can effectively serve.
