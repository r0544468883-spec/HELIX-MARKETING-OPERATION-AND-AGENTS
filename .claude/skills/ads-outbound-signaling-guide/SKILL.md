---
name: "ads-outbound-signaling-guide"
title: LinkedIn ads and outbound signaling
description: "Use this skill when connecting paid campaigns to sales outreach — using ABM ad engagement as intent signals that trigger and personalize BDR outbound before anyone fills out a form."
category: ABM
---
...
When Fibbler pushes engagement data to HubSpot, the campaign name reveals the intent:
...
|---|---|---|
| `ABM Intent` | Multi-checkbox | Workflow: parse campaign name from Fibbler → assign intent checkboxes |
...
```
Trigger: Fibbler updates company engagement properties
...
| **Campaign group engagement** | Fibbler dashboard / HubSpot | Shows depth of interest |
| **Engagement recency** | HubSpot (7d/30d/90d properties) | Timing - reach out when engagement is fresh |
| **Ad content they clicked** | Fibbler qualitative data | Know exactly which messaging resonated |
...
|---|---|---|
| **Reply rate from ABM-warmed leads** | Replies ÷ outreach sent (Interested stage only) | Meaningfully above your own cold baseline - measure the lift |
...
- Tools like Fibbler aggregate at campaign-group level to maximize signal extraction
...
| **Fibbler** | LinkedIn → CRM connector | Pushes both quantitative (impressions, clicks, engagements per account) and qualitative engagement (which campaigns), auto-updates ABM stages, intent detection |
...
| **HubSpot Sales** | Outbound sequencing | Personalized multi-touch sequences based on intent |
