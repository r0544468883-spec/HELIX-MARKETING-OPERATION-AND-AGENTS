...
No single ideal size - but the consistent lesson across campaigns is: too narrow kills performance. Directional ranges that work well:

- **Typical prospecting range:** roughly 50K-400K. Smaller pools (10K-100K) can still work with the right bidding.
- **If total addressable is under ~30K:** skip the TOF/BOF split and saturate the whole audience with all layers.
- **For prospecting generally:** aim for 100K+ members, starting ICP-first and expanding over time.

**What happens when too narrow:**
- CPMs spike far above benchmark
- Algorithm can't optimize - not enough data points
- Audience penetration stays very low (single-digit percentages)
...
## Job Functions vs Job Titles: The Big Test

A large-scale, multi-month experiment comparing job function targeting vs job title targeting.
...
**Source:** LinkedIn targeting documentation - BD function definition: "development of business opportunities and relationships, including mergers, partnerships, and business initiatives."
...
- Also split by industry when product has significantly different use cases per vertical (e.g., Salesforce has completely different value props for transportation vs tech)
...
**Critical:** Audience Expansion is auto-enabled in campaign setup. Always turn it OFF. LinkedIn's similarity matching is unreliable - e.g., targeting marketing managers, LinkedIn finds a Harvard attendance pattern, and targets Harvard alumni regardless of role.
...
**Profile visitor connection strategy:** When someone views your LinkedIn profile (often triggered by seeing your ads or TLAs), send them a blank connection request through Sales Navigator. Acceptance rate on these is high - typically much higher than cold connection requests - because they've already shown interest by visiting your profile.
