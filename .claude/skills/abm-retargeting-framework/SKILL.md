---
name: "abm-retargeting-framework"
title: ABM retargeting framework
description: "Use this skill when building retargeting for ABM — segmenting engaged accounts, managing frequency, and orchestrating retargeting across ads, email, BDR outreach, and direct mail."
category: ABM
---
...
| Funnel Stage | Frequency Target | Notes |
|---|---|---|
| **TOF / MOF (nurture)** | ~4 per person per week | Sustainable with 3-4 rotating creatives |
| **BOF (near decision)** | up to ~15 per person per 30 days | Higher reinforcement is intentional for accounts close to buying |
...
| **Frequency climbing above the ~4/week target** | Any segment | Add or rotate creatives so variety keeps it productive |
| **~8+/week on a single creative** | Same person seeing one ad repeatedly | Creative fatigue - rotate in fresh ads or expand the audience (do not just pause) |
