---
name: "linkedin-ads-abm-guide"
title: LinkedIn ads for ABM
description: "Use this skill when planning or running LinkedIn ad campaigns for ABM — ad format selection, budget math, campaign structure, performance benchmarks, and optimization."
category: ABM
---
...
| **Thought Leader Ads (TLAs)** | ~4-5%* | ~$60-70* | Top-of-funnel awareness, events, webinars. *Runs on an engagement objective, so this is an engagement rate (read-more, reactions, profile clicks, tags) - NOT a click-through-rate to a landing page. Do not compare it to a website-visits CTR.* | Awareness |
| **Carousel Ads** | Moderate | ~$8-12 | Multi-feature showcases, comparison content | Interested |
| **Video Ads** | ~0.3% | ~$20-25 | Brand awareness, product demos, case studies | Awareness → Interested |
...
*Figures above are directional benchmarks; treat them as starting expectations and validate against your own account data.*

### Objective by stage (warming vs traffic)

**To warm up a cold audience, use an engagement objective - not a website-visits objective.** The right warm-up formats are **single-image ads, document ads, and Thought Leader Ads, all run on engagement.** A website-visits objective is the wrong choice for warming: you optimize (and pay) for a landing-page click before the account has any intent, so you burn budget. Move to traffic/conversion objectives only at the WARM stage, once accounts have already engaged.

### Formats by funnel stage

**Top of funnel (warm-up, engagement objective).** Thought Leader Ads and Document Ads are the main formats, with Single Image supporting. Thought Leader Ads run on the engagement objective. Goal: build trust and fill the retargeting pool - no hard sell.

**Middle of funnel (consideration, retargeting engaged accounts).** Document Ads and Single Image - case studies, before/after, proof that moves the account toward a decision.

**Bottom of funnel (conversion, hot/high-intent accounts).** Single Image with a direct CTA, Testimonial ads, and Conversation Ads (conversion-focused). Thought Leader Ads with conversion-focused copy can also work here.

**Testimonial ads (worth calling out).** If a customer posted about you on their own profile, you can promote that post - third-party proof, same mechanic as a Thought Leader Ad. Variations, strongest first: video testimonial from a customer, written testimonial, single-image testimonial, influencer/non-employee, and your own team/CEO/founder.
...
| **CTR (TLA)** | ~4-5%* | *Engagement rate under an engagement objective (counts all click types: read-more, reactions, profile clicks). NOT landing-page CTR - not comparable to a website-visits CTR |
| **CPC (Single Image)** | $8-19 | Varies by audience size and competition |
| **CPC (Video)** | ~$20-25 | More expensive per click |
| **CPC (TLA)** | ~$60-70 | Expensive but drives event signups |
...
| **Accounts progressing Aware → Interested** | 30% | Below 20% |
| **Accounts progressing Interested → Considering** | 20% | Below 10% |
...
| Tool | Function |
|---|---|
| **HubSpot** | CRM and workflows; syncs company lists to LinkedIn ad audiences |
| **ContactLevel** | Contact enrichment |
| **Fibbler** | LinkedIn ad engagement → CRM sync |
| **Freckle** | Ad audience sync |
| **LinkedIn Campaign Manager** | Ad management, targeting, delivery |

These are the specific tools in the stack. Cost varies with seats and usage, so there's no single fixed monthly number - budget for it based on your own plan tiers.
