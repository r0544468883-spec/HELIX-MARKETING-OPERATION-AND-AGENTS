...
|------|---------|-----------|
| **SPICED** | WHAT to say (substance) | Use Case Canvas |
| **Use Case Canvas** | WHERE to put it (structure) | Copy outlines |
| **Opposites** | HOW to say it (contrast) | Every headline, email, post |
